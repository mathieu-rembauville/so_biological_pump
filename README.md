...
3_application : Applies the transfer functions to the sediment cores diatom assemblages. 

4_comparison : Compare the reconstructed POC flux and PIC:POC export ratio with previously published data for cores PS1768-8, PS1786-1, PS2606-6 and PS75/072-4.
